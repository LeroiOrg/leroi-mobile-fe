...
// Colores que coinciden exactamente con el CSS web
const colors = {
  ...
  primary: '#1E1E2F', // --primary
  primaryForeground: '#FFFFFF', // --primary-foreground
  secondary: '#2A2D3A', // hsl(217.2, 32.6%, 17.5%)
  secondaryForeground: '#FFFFFF', // hsl(210, 40%, 98%)
  
  // Componentes UI
  card: '#101838', // --card (tema oscuro)
  cardForeground: '#FFFFFF', // --card-foreground
  popover: '#0A0A0A', // --popover
  popoverForeground: '#FFFFFF', // --popover-foreground
  muted: '#2A2D3A', // --muted
  mutedForeground: '#A1A1AA', // hsl(215, 20.2%, 65.1%)
  accent: '#2A2D3A', // --accent
  accentForeground: '#FFFFFF', // --accent-foreground
  
  // Colores de interacción
  hover: '#835BFC', // --hover
  buttonHover: '#6B4AD4', // --button-hover
  navbar: '#835BFCCC', // --navbar (con transparencia)
  
  // Texto
  text: '#FFFFFF', // --foreground
  textSecondary: '#A1A1AA', // --muted-foreground
...
const styles = StyleSheet.create({
  ...
  featureIconContainer: {
    ...
    alignItems: 'center',
    marginBottom: SPACING_MD,
    backgroundColor: 'rgba(131, 91, 252, 0.1)', // colors.hover with opacity
    borderRadius: 20,
  },
  cardText: {
    color: colors.cardForeground,
